...
namespace SoftUni.Data
{
    public partial class SoftUniContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                // The class SoftUniDBConfug is a static class that is not uploaded to the GitHub Repo!
                // In the class, there is a static string field with the connection string you need to connect with the DB.
                optionsBuilder.UseSqlServer(SoftUniDBConfug.ConnectionString);
            }
        }
